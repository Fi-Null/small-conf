				...
				<ul class="nav navbar-nav">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
							当前环境：
								<#list envList as item>
									<#if SMALL_CONF_CURRENT_ENV == item.env>
										${item.title}(${item.env})
									</#if>
								</#list>
                    ...
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
							欢迎 ${Request["SMALL_CONF_LOGIN_IDENTITY"].username}
							<span class="caret"></span>
						</a>
                        <ul class="dropdown-menu" role="menu">
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if Request["SMALL_CONF_LOGIN_IDENTITY"].permission == 1>
...
<#macro commonFooter >
	<footer class="main-footer">
		Powered by <b>SMALL-CONF</b> 1.6.2-SNAPSHOT
		<div class="pull-right hidden-xs">
			<strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="https://www.xuxueli.com/" target="_blank" >xuxueli</a>
                &nbsp;
                <a href="https://github.com/fi-null/small-conf" target="_blank" >github</a>
